...
Its a direct copy of the 1.1x kasm workspaces image repo, ive just been adding my own to it. 

some of the images are considered dangerous, im not using this for the zero trust aspect, im passing things through to the containers like KVM etc to run emulators and what not in them
